...
K_MSGQ_DEFINE(module1_in_msgq, sizeof(module1::module1_in_msgs), 10,
              1); // NOLINT

ZBUS_CHAN_DEFINE(module1_in_chan, /* Name */             // NOLINT
                 module1::module1_in_msgs,               /* Message type */
                 NULL,                                   /* Validator */
                 NULL,                                   /* User data */
                 ZBUS_OBSERVERS(listen), /* observers */ // NOLINT
...
void entry(void * /* arg1 */, void * /* arg2 */, void * /* arg3 */)
{
    ...
    {
        LOG_INF("Sending Out");
        send_message<module1_out_msgs>(&module1_out_chan,
                                       module1_out_msg_a{.value = {"Hello"}},
                                       K_NO_WAIT);
        k_msleep(500); // NOLINT
...
ZBUS_LISTENER_DEFINE(listen, listener_callback); // NOLINT